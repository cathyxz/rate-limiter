...
var _rateLimiter = __webpack_require__(1);
...
function rateLimit(fn) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { interval: 1000, maxTries: 10 };

    var triesWithinInterval = 0;
    var interval = setTimeout(function () {
        this.triesWithinInterval = 0;
    }, options.interval).bind(this);
    return function () {
